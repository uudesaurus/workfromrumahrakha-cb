        ...
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center">
            <div className="relative">
              <h1 className="text-lg font-medium text-white tracking-wide">workfromrumahrakha</h1>
              <div className="absolute -bottom-1 left-0 w-full h-px bg-gradient-to-r from-white/50 via-white/20 to-transparent"></div>
            </div>
          </div>

          <nav className="hidden md:flex items-center space-x-1">
            {["Home", "About", "Projects", "Thoughts", "Contact"].map((item, index) => (
              <a
                key={item}
